...
*/
public class AltaStockRodamiento extends javax.swing.JFrame {
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				AltaStockRodamiento inst = new AltaStockRodamiento();
	...
	private static AltaStockRodamiento instancia;
	
	public static AltaStockRodamiento getInstancia()
	{
		if (instancia == null)
			instancia = new AltaStockRodamiento();
		return instancia;
	}	
	
	public AltaStockRodamiento() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				jButton1.setBounds(337, 391, 56, 23);
				jButton1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent evt) 
					{
						...
						ItemStock i = Sistema.getSistema().ItemStock_Alta_Ingreso(tbCodigo.getText(), tbMarca.getText(), tbNroSerie.getText(), tbOrigen.getText(), tbSufijo.getText(), Integer.parseInt(tbCantidad.getText()), tbEst.getText(), Float.parseFloat(tbPC.getText()), Float.parseFloat(tbPV.getText()), d);	
						if(i!=null){
							Sistema.getSistema().ItemStock_Alta_Confirmacion(i.getRodamiento().getCodigo(), i.getPrecioCosto());
							cerrar();
						}
					}
				});						
			...
			}
			{
				...
				jTextField4.setBounds(200, 136, 193, 23);
			}
			{
